...
//        WHERE name IN ('admin','manager','employee')`
//     );
...
//     // ── Insert Employee Roles (M2M Table) ─────────────
//     const employeeRoles = [

//       {
//         employee_id: empMap['PINT099'],
...
//       // {
//       //   employee_id: empMap['PINT091'],
//       //   role_id: roleMap['employee'],
//       //   is_primary: true,
//       //   assigned_at: now
//       // }

//     ].filter(r => r.employee_id && r.role_id);
...
//     // ── Delete Employee Roles First (FK safety) ───────
